...
const ProductForm: React.FC<ProductFormProps> = ({ handleSubmit, action = 'Adicionar' }) => {
  ...
  const { data: categoriesData, error: categoriesError } = useSwr('/admin/v1/categories?length=999', CategoriesService.index);
  ...
  if (categoriesError || systemRequirementsError) {
